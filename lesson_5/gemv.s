...
label_outer_loop:
    ...
    buffer_load_dword v[aData], v[glOffset], s[srdA:srdA+3], s[loadOffsetA] offen offset:0
    s_mul_i32 s[loadOffsetX], s[colIdx], bpe
    v_mov_b32 v[glOffset], 0
...
label_outer_loop_end:
    ...
    s_waitcnt vmcnt(0)
    v_add_f32 v[accData], v[accData], v[yData]
